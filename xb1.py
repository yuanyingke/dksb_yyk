...
def qd(aliyungf_tc, acw_tc, para_list):
    ...
    try:
        ...
        print(f"headers:{headers} json: {payload}")
        print(f"请求返回结果：{response}")
        print(f"请求返回结果：{response.text}")
        print(f"请求状态码：{response.status_code}")
    except Exception as e:
        print(f"签到/签退请求失败：{str(e)}")
# "Cookie": "aliyungf_tc=1a75b96d002800001704aa90bce35f5e318a48e1721e039051ca0023c749709b; acw_tc=2f6fc11116800515360423690e6575f622e5c67af65f4838fdd2d97a7a5f73",
# "phoneNum": "16601158994",
# "name": "丁浩",
# "flag": 1 签到 2 签退,
# "buildingNum": "6",
# "floorNum": "6",
...
if __name__ == "__main__":
    ...
    if token is None:
        ...
        para_list = ["18335835825", '袁迎科', '2', '6', '6', 'A122']
